...
public class FinalUpgrade : MonoBehaviour
{
    ...
    [SerializeField] private GameObject gameOverUpgrade;
    ...
    private void Start()
    {
        ...
        if (DataManager.Instance.hasFoundFinalUpgrade)
        {
            upgradeButton.enabled = false;
            gameOverUpgrade.SetActive(true);
        }
    }
    ...
    public void FinalUpgradeFunction()
    {
        SFX.Instance.PlayClickSound();
        UpdateCashInDataManagerOnClick();
        DataManager.Instance.FinalUpgrade();
        gameOverUpgrade.SetActive(true);
        upgradeButton.enabled = false;
    }
}
